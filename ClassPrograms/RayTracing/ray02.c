...
void method()
{
   ...
   for(j = 0; j<Y; j++)
   {
      for(i = 0; i<X; i++)
      {
         ...
         //n.x = (s[minSphere].c.x - pos.x)/(s[minSphere].r);
         //n.y = (s[minSphere].c.y - pos.y)/(s[minSphere].r);
         //n.z = (s[minSphere].c.z - pos.z)/(s[minSphere].r);
           // printf("%f\n", abs(dotp(l, n));
         if(shade == .45)
         {
            //shade *= .4;
         ...
         {
            //dot l and 
            //(pos.x - s[minsphere].c.x)/(s[minsphere].r)
